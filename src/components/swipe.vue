...
export default {
  ...
  methods:{
    handleScroll(){   
      ...
      markDot = parseInt((scrollDis+contentWidth)/contentWidth);
      console.log(markDot)
      // let dot = document.getElementsByClassName("bars")[0];
      let activeDot = document.getElementsByClassName('barsActive')[1];
  ...
  mounted(){
    ...
    let activeDot1 = document.getElementsByClassName("bars")[1];
    this.addClass(activeDot1,'barsActive')
    });
  }
}
</script>
